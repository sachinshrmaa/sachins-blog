    ...
    return (
        ...
        <div id="revue-embed">
          ...
          <ul class="nav justify-content-center mt-4">
            <li class="nav-item">
                <a class="nav-link text-white" target="blank" href="https://twitter.com/sachinshrmaa/">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" target="blank" href="https://facebook.com/sachinshrmaa/">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" target="blank" href="https://instagram.com/sachinshrmaa/">
