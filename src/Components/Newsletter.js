            ...
            <div class="col-md-9 col-11 m-auto">
                ...
                <div id="revue-embed" class="mt-md-5 mt-4">
                    <form action="https://www.getrevue.co/profile/sachinshrmaa/add_subscriber" method="post" id="revue-form" name="revue-form"  target="_blank">
                        <input class="revue-form-field newsletter-inp border-0 rounded px-2" placeholder="Your email address..." type="email" name="member[email]" id="member_email" />
                        &nbsp;
                        <input type="submit" value="Join" name="member[subscribe]" id="member_submit" class="btn px-5 py-2 mt-3 mt-md-0 text-white" />
                    </form>
                </div>
                ...
                <ul class="nav justify-content-center mt-4">
                    <li class="nav-item">
                        <a class="nav-link" target="blank" href="https://twitter.com/sachinshrmaa/">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" target="blank" href="https://facebook.com/sachinshrmaa/">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" target="blank" href="https://instagram.com/sachinshrmaa/">
