                    ...
                    <Helmet>
                        ...
                        <div class="row d-flex ">
                            ...
                            <ul class="nav justify-content-center m-0">
                                <li class="nav-item">
                                    <a class="nav-link" target="blank" href={`https://twitter.com/share?url=https://www.sachinsblog.in/${post.slug}`} target="blank">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " target="blank" href={`https://www.facebook.com/sharer/sharer.php?u=https://www.sachinsblog.in/${post.slug}`} target="blank">
