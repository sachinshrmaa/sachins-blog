  ...
  return (
    <div className={styles.newsletterCard}>
      ...
      <div className="mt-md-4 mt-4">
        <form
          className="col-md-7 m-auto container"
          action="https://sachinsblog.us10.list-manage.com/subscribe/post?u=5e93d1e3a83679d27d02d635f&amp;id=13e8fc99a7&amp;f_id=0050cbe5f0"
          method="post"
        ...
        >
          ...
          <div aria-hidden="true">
            <input
              type="text"
              name="b_5e93d1e3a83679d27d02d635f_13e8fc99a7"
              tabindex="-1"
              value=""
              className="d-none"
            />
      ...
      <ul className="nav justify-content-center mt-4">
        ...
        <li className="nav-item">
          <a
            className="nav-link text-dark"
            target="blank"
            href="https://facebook.com/sachinshrmaa/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
