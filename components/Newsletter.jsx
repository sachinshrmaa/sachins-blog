        ...
        <div className="container">
            <div className={styles.newsletterCard}>
                ...
                <div className="mt-md-5 mt-4">
                    ...
                    <form className="col-md-7 m-auto container" action="https://sachinsblog.us10.list-manage.com/subscribe/post?u=5e93d1e3a83679d27d02d635f&amp;id=13e8fc99a7&amp;f_id=0050cbe5f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_self">
                ...
                <ul className="nav justify-content-center mt-4">
                    <li className="nav-item">
                        <a className="nav-link text-white" target="blank" href="https://twitter.com/sachinshrmaa/">
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-white" target="blank" href="https://facebook.com/sachinshrmaa/">
                    ...
                    <li className="nav-item">
                        <a className="nav-link text-white" target="blank" href="https://instagram.com/sachinshrmaa/">
