  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="SachinsBlog Insider is a weekly newsletter where every week I set aside an hour or two just to send my insider curated list of content related to self-development, tech, well-being, and more straight into your inbox."
        />
