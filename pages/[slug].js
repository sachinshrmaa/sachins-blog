                    ...
                    <div className="row d-flex ">
                        ...
                        <ul className="nav justify-content-center m-0">
                            <li className="nav-item">
                                <a className="nav-link" href={`https://twitter.com/share?url=https://www.sachinsblog.in/${post.slug}`} target="blank"  rel="noreferrer">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href={`https://www.facebook.com/sharer/sharer.php?u=https://www.sachinsblog.in/${post.slug}`} target="blank" rel="noreferrer" >
